<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Composition.aspx.cs" Inherits="cfs.Web.cfsadmin.QuestionManagement.Composition" %>
    ...
    <div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar" id="admin" runat="server">
                <li><a class="icon" href="QuestionManagement/Details/CompositionDetail.aspx?qsid={qsid}&type=CompositionDetail&page=<%=NumPerPage %>&pagenum=<%=PageNum %>"
                    target="dialog" rel="catemodadd" width="500" height="370"><span>查看详细</span></a></li>
                <li class="line">line</li>
                <li><a class="add" href="QuestionManagement/Details/CompositionDetail.aspx?type=CompositionAdd&page=<%=NumPerPage %>&pagenum=<%=PageNum %>"
                    target="dialog" rel="catemodadd" width="500" height="370"><span>新增</span></a></li>
                <li class="line">line</li>
                <li><a title="确实要删除这些记录吗?" target="ajaxTodo" href="../../Controls/BaseData/DealMain.ashx?qsid={qsid}&type=del&page=<%=NumPerPage %>&pagenum=<%=PageNum %>"
                    warn="请选择一条记录" class="delete" title="确定要删除这条信息吗?"><span>删除</span></a></li>
                <li class="line">line</li>
                <li><a class="edit" href="QuestionManagement/Details/CompositionDetail.aspx?qsid={qsid}&type=CompositionEdit&page=<%=NumPerPage %>&pagenum=<%=PageNum %>"
