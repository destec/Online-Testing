...
namespace cfs.Web.cfsadmin.QuestionManagement
{
    public partial class Translation : System.Web.UI.Page
    {
        ...
        private void BindData(int numPerPage, int pageNum)
        {
            ...
            //根据Session值查表
            string sqlwhere = "ES_TYPE = 4 AND ES_DELFLAG = 0";
            TotalCount = bll.GetRecordCount(sqlwhere);
            ds = bll.GetListByPage(sqlwhere, "ES_ID DESC", (pageNum - 1) * numPerPage + 1, pageNum * numPerPage);
            sb.Append("<table class=\"table\" width=\"80%\" layouth=\"74\"><thead><tr align='center'><th>题目编号</th><th width=\"70%\">题目</th><th width='5%'>难易度</th><th width='10%'>创建教师</th></tr></thead>");
            sb.Append("<tbody>");
