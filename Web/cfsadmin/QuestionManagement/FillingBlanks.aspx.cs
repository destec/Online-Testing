...
{
    public partial class FillingBlanks : System.Web.UI.Page
    {
        #region 字段与属性
        /// <summary>
        /// 每页显示的条数
        ...
        private void BindData(int numPerPage, int pageNum)
        {
            ...
            //根据Session值查表
            string sqlwhere = "ES_TYPE = 3 AND ES_DELFLAG = 0";
            TotalCount = bll.GetRecordCount(sqlwhere);
            ds = bll.GetListByPage(sqlwhere, "ES_ID DESC", (pageNum - 1) * numPerPage + 1, pageNum * numPerPage);
            sb.Append("<table class=\"table\" width=\"80%\" layouth=\"74\"><thead><tr align='center'><th>题目编号</th><th width=\"15%\">文章标题</th><th width=\"60%\">文章内容</th><th width='5%'>难易度</th><th width='10%'>创建教师</th></tr></thead>");
            sb.Append("<tbody>");
